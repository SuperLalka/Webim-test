...
SECRET_KEY = 'b&q#3now^*xsw$paicm8ch*fgcvg!sl+aqw!o4ikpvp9afgv%('
...
STATIC_ROOT = os.path.join(BASE_DIR, 'login_app/static')

# OAuth Github settings

GITHUB_CLIENT_KEY = '7c443d61ceb9dfce4598'
GITHUB_CLIENT_SECRET = '53e9232c473ca65775fd6e8e08b8b7d990f30dda'
